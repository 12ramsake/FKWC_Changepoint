############ Perform FKWC on imaging data
#You need the package numDeriv
# imag_array is a four dimensional array of the f-mri images, where the fourth dimension is the time in the sequence
#
...
source('FKWC Methods.R')

cp=PELT_T(ranks,.3*sqrt(dim(imag_array))+3.74)
cp
